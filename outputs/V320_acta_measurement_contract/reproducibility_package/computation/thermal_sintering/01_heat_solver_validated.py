#!/usr/bin/env python3
"""Transient 1-D heat-conduction solver + analytical verification (Component 1).
...
def main():
    ...
    print("== Component 1: transient heat solver, analytical verification ==")
    ...
    assert rel < 1e-3, "verification FAILED: solver does not match analytical erfc"
    print("VERIFICATION PASSED: solver reproduces the analytical erfc response to <0.1% (relative).")

    # save verification arrays for the figure
    ...
    print("saved out_01_validation.npz (legacy filename; verification arrays)")
